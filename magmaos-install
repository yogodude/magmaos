    ...
    local files = {
      {
        name = "magmaos-install",
        url = "https://raw.github.com/yogodude/magmaos/"..branch.."/magmaos-install.lua"
      },
      {
        name = "startup",
        url = "https://raw.github.com/yogodude/magmaos/"..branch.."/startup.lua"
      },
      {
        name = "chat",
        url = "https://raw.github.com/yogodude/magmaos/"..branch.."/chat.lua"
      }
    }
